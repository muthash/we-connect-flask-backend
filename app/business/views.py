...
from app.utils import (
    ...
    remove_none_fields, filter_business)
...
class BusinessManipulation(BaseView):
    ...
    def get(self, business_id):
        ...
        if business_id is None:
            ...
            page_items_list = [business.serialize()
                               for business in page_items.items]
            if page_items_list:
            ...
            business = Business.query.filter_by(id=business_id).first()
            if business:
                reviews = [review.serialize() for review in business.reviews]
